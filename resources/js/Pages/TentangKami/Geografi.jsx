...
export default function Geografi(props) {
    return (
        <>
            ...
            <div className="relative w-full bg-white text-lg lg:text-xl flex flex-col justify-start items-center gap-10 sm:gap-20 md:gap-24 lg:gap-28 object-cover rounded-t-[20px] lg:rounded-t-[50px] text-black">
                ...
                <div className="w-full max-w-6xl h-auto text-base md:text-lg lg:text-xl px-4 z-10">
                    <br />
