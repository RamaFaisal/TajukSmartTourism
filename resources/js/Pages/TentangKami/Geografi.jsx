...
export default function Geografi(props) {
    return (
        <>
            ...
            <div className="relative w-full bg-white text-lg lg:text-xl flex flex-col justify-start items-center gap-16 sm:gap-24 md:gap-24 lg:gap-28 object-cover rounded-t-[20px] lg:rounded-t-[50px] text-black">
                ...
                <div className="w-full max-w-[1090px] px-4 md:px-8">
                    <div className="aspect-[4/3] sm:aspect-video w-full overflow-hidden rounded-lg">
                        <iframe
                ...
                <div className="w-full lg:w-[1160px] h-auto text-base md:text-lg lg:text-xl px-4 z-10">
                    <br />
                    <p className="px-5 text-lg md:text-2xl text-justify font-sans">
